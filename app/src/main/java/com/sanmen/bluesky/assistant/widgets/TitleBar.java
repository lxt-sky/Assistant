package com.sanmen.bluesky.assistant.widgets;
...
public class TitleBar extends LinearLayout {
    ...
    public TitleBar(Context context, AttributeSet attrs) {
        ...
        titleTextColor = typedArray.getColor(R.styleable.TitleBar_titleTextColor, ContextCompat.getColor(getContext(), R.color.black_text));
        ...
        rightTextColor = typedArray.getColor(R.styleable.TitleBar_rightTextColor, ContextCompat.getColor(getContext(), R.color.black_text));
